...
export default function DashboardAdmin() {
  ...
  return (
    <div className="h-screen flex bg-stone-100 text-stone-850 font-sans overflow-hidden print:h-auto print:overflow-visible print:bg-white">
      
      {/* Sidebar Panel */}
      <aside className="w-64 bg-white border-r border-stone-200 flex flex-col justify-between flex-shrink-0 h-full text-left print:hidden">
        <div>
          {/* Header Panel */}
      ...
      <main className="flex-1 flex flex-col overflow-hidden h-full print:h-auto print:overflow-visible">
        ...
        {/* Header Bar */}
        <header className="h-20 bg-white border-b border-stone-200 px-8 flex items-center justify-between flex-shrink-0 text-left print:hidden">
          <div>
          ...
          <div className="flex items-center gap-4">
            <div className="text-right">
              <p className="text-sm font-extrabold text-stone-900">Admin</p>
              <p className="text-[10px] text-stone-500 font-semibold uppercase tracking-wider">Kepala UPT</p>
            </div>
            <div className="w-10 h-10 rounded-full bg-emerald-600 text-white font-bold text-lg flex items-center justify-center border-2 border-stone-100 shadow-sm uppercase">
              A
            </div>
          </div>
        </header>
        ...
        <div className="flex-grow p-8 overflow-y-auto h-full text-left print:p-0 print:overflow-visible">
