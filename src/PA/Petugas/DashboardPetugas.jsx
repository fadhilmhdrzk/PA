...
export default function DashboardPetugas() {
  ...
  return (
    <div className="h-screen flex bg-stone-100 text-stone-850 font-sans overflow-hidden">
      
      {/* Sidebar Panel */}
      <aside className="w-64 bg-slate-900 text-slate-100 flex flex-col justify-between flex-shrink-0 h-full text-left">
        <div>
          {/* Header Panel */}
      ...
      <main className="flex-1 flex flex-col overflow-hidden h-full">
        ...
        {/* Header Bar */}
        <header className="h-20 bg-white border-b border-stone-200 px-8 flex items-center justify-between flex-shrink-0 text-left">
          <div>
          ...
          <div className="flex items-center gap-4">
            <div className="text-right">
              <p className="text-sm font-extrabold text-stone-900">{activeNurse.nama}</p>
              <p className="text-[10px] text-emerald-700 font-bold uppercase tracking-wider">Perawat</p>
            </div>
        ...
        <div className="flex-grow p-8 overflow-y-auto h-full text-left">
